<div class="sm:h-99 mx-3 mb-5 grid gap-4 sm:grid-cols-2 sm:grid-rows-3 md:h-auto md:grid-cols-5 md:grid-rows-2">
    <a href="{{ route("pizza.list") }}" wire:navigate
    ...
    <a href="{{ route("side.list") }}" wire:navigate style="background-image: url('{{ asset("storage/categories/sides.png") }}')"
    ...
    <a href="{{ route("dessert.list") }}" wire:navigate
    ...
    <a href="{{ route("drink.list") }}" wire:navigate
